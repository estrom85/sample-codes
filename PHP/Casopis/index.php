...
if(isset($_GET['rubrika'])){
    ...
    require_once $homedir."modules/Intro.php";
    $program=new Intro();
    $style="intro.css";
}
/*
...
<html>
  <head>
    <title>Sedemnástka - internetový časopis ZŠ 17. novembra v Sabinove</title>
        ...
        <script type="text/javascript" src="scripts/fancyapps-fancyBox-e4836f7/lib/jquery.mousewheel-3.0.6.pack.js"></script>
        <link rel="stylesheet" type="text/css" href="scripts/fancyapps-fancyBox-e4836f7/source/jquery.fancybox.css?v=2.1.3">
        <script type="text/javascript" src="scripts/fancyapps-fancyBox-e4836f7/source/jquery.fancybox.pack.js?v=2.1.3"></script>
    
        <link rel="stylesheet" type="text/css" href="scripts/fancyapps-fancyBox-e4836f7/source/helpers/jquery.fancybox-buttons.css?v=1.0.5">
        <script type="text/javascript" src="scripts/fancyapps-fancyBox-e4836f7/source/helpers/jquery.fancybox-buttons.js?v=1.0.5"></script>
        <script type="text/javascript" src="scripts/fancyapps-fancyBox-e4836f7/source/helpers/jquery.fancybox-media.js?v=1.0.5"></script>

        <link rel="stylesheet" type="text/css" href="scripts/fancyapps-fancyBox-e4836f7/source/helpers/jquery.fancybox-thumbs.css?v=1.0.7">
        <script type="text/javascript" src="scripts/fancyapps-fancyBox-e4836f7/source/helpers/jquery.fancybox-thumbs.js"></script>
        ...
        <script type="text/javascript">
            ...
            $(document).ready(function(){
                ...
                links_widget.add("Školský časopis - Sedemnástka","www.sedemnastka.6f.sk");
                links_widget.add("Zahrajte sa - superhry.cz","www.superhry.cz");
                links_widget.add("Maľované krížovky","www.griddlers.net");
  ...
  <body>
      <div id="main" class="main">
          <div id="header" class="header">
              ...
              <span id="school" class="school">Internetový časopis ZŠ Ul. 17. novembra v Sabinove </span>
              </div>
          </div>
          <?php $menu->display();?>
